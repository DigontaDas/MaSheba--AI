...
const QA_ROWS: OfflineQaSeedRow[] = [
  ...
  },
  {
    ...
    answer_bn: "রক্তচাপ বেশি হলে বিশ্রাম নিন এবং আবার মাপুন। মাথা ব্যথা, চোখে ঝাপসা দেখা, বা শরীর ফুললে বিপদ হতে পারে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "একবার নয়, বারবার বেশি দেখালে বিষয়টি গুরুত্বের। লবণ কম খান, বিশ্রাম নিন, এবং নিজের সিদ্ধান্তে ওষুধ খাবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "হ্যাঁ, মাথা ব্যথা না থাকলেও রক্তচাপ বেশি থাকা ঝুঁকির লক্ষণ হতে পারে। নিয়মিত মাপা দরকার। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "হাত পা ফুললে রক্তচাপ মাপা দরকার। মুখ ফুলে যাওয়া বা মাথা ব্যথা থাকলে আরও সতর্ক হতে হবে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শেষ দিকে রক্তচাপ বাড়লে মা ও শিশুর নজরদারি দরকার। বেশি কাজ বন্ধ করে বিশ্রাম নিন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "দুর্বল লাগা রক্ত কমে যাওয়া বা খাবার কম খাওয়ার কারণে হতে পারে। আয়রনসমৃদ্ধ খাবার খান এবং পরীক্ষা দরকার হতে পারে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "মুখ ফ্যাকাশে ও মাথা ঘোরা রক্তশূন্যতার লক্ষণ হতে পারে। বিশ্রাম নিন, পুষ্টিকর খাবার খান, এবং পরীক্ষা করান। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শ্বাসকষ্ট ও দুর্বলতা রক্ত কমে যাওয়া বা অন্য সমস্যার কারণে হতে পারে। কাজ বন্ধ করে বসে পড়ুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "ডাল, শাক, ডিম, মাছ, কলিজা, ছোলা, খেজুর, এবং লেবু জাতীয় ফল খেতে পারেন। ট্যাবলেট দরকার কি না জানতে হবে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "নিজে থেকে ট্যাবলেট বন্ধ করবেন না। কখন খেলে সহ্য হয় তা স্বাস্থ্যকর্মী বুঝিয়ে দিতে পারেন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "সত্যিকারের ব্যথা নিয়মিত আসে, ধীরে ধীরে বাড়ে, এবং বিশ্রামে কমে না। পানি ভাঙা বা রক্তমিশ্রিত স্রাব থাকলে প্রস্তুতি নিন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "মিথ্যা ব্যথা অনেক সময় অনিয়মিত হয় এবং বিশ্রামে কমে যেতে পারে। তবু পানি, রক্ত, বা ব্যথা বাড়লে অবহেলা করবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "নিয়মিত ব্যথা, পানি ভাঙা, রক্তমিশ্রিত স্রাব, বা বাচ্চা কম নড়লে হাসপাতালে যাওয়ার প্রস্তুতি নিন। দূরের পথ হলে আগে বের হওয়া ভালো। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শেষ দিকে পেট শক্ত হয়ে আবার নরম হতে পারে। সময়ের ব্যবধান কমে গেলে বা ব্যথা বাড়লে প্রসব শুরু হতে পারে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "কোমর থেকে পেটে ছড়ানো নিয়মিত ব্যথা প্রসবের লক্ষণ হতে পারে। ব্যাগ প্রস্তুত রাখুন এবং একা থাকবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "প্রসবের আগে হালকা রক্তমিশ্রিত স্রাব হতে পারে। কিন্তু রক্ত বেশি হলে জরুরি। বিষয়টি যাচাই করা দরকার। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "পানি ভাঙলে সংক্রমণের ঝুঁকি থাকে। ব্যথা না থাকলেও পরিষ্কার কাপড় ব্যবহার করুন এবং দেরি করবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "বেশি রক্ত, জ্বর, দুর্গন্ধযুক্ত স্রাব, খিঁচুনি, অজ্ঞান হওয়া, বা শ্বাসকষ্ট হলে দ্রুত সাহায্য দরকার। পরিবারকে বিষয়টি জানিয়ে রাখুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "হালকা ব্যথা হতে পারে, কিন্তু ব্যথা বাড়লে বা জ্বর থাকলে পরীক্ষা দরকার। পরিষ্কার-পরিচ্ছন্ন থাকুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "প্রস্রাবে জ্বালা সংক্রমণের লক্ষণ হতে পারে। বেশি পানি পান করুন, কিন্তু পরীক্ষা ছাড়া নিজে ওষুধ খাবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "সেলাইয়ের জায়গা পরিষ্কার ও শুকনা রাখুন। ব্যথা বাড়লে, পুঁজ বের হলে, বা জ্বর হলে পরীক্ষা দরকার। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "প্রস্রাবে জ্বালা মূত্রনালির সংক্রমণের লক্ষণ হতে পারে। বেশি পানি পান করুন এবং প্রস্রাব চেপে রাখবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শরীরে পানি কমে গেলে প্রস্রাব কম ও গাঢ় হতে পারে। বমি বা জ্বর থাকলে ঝুঁকি বাড়ে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "চুলকানি ও স্রাব সংক্রমণ বা জ্বালার কারণে হতে পারে। জায়গা পরিষ্কার রাখুন এবং নিজে কোনো ওষুধ ব্যবহার করবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "কাশি জ্বর থাকলে বিশ্রাম নিন, পানি পান করুন, এবং অন্যদের থেকে একটু দূরে থাকুন। শ্বাসকষ্ট বা জ্বর বেশি হলে পরীক্ষা দরকার। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "গর্ভাবস্থায় নিজে ওষুধ খাওয়া ঠিক নয়। জ্বরের কারণ জানা দরকার। পানি পান করুন ও বিশ্রাম নিন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "হালকা টান লাগতে পারে, কিন্তু তীব্র ব্যথা বা রক্ত থাকলে ঝুঁকি থাকে। বিশ্রাম নিন এবং লক্ষণ খেয়াল করুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "পিঠে ব্যথা সাধারণ হতে পারে, তবে ব্যথা খুব বাড়লে বা জ্বর থাকলে পরীক্ষা দরকার। ভারী কাজ বন্ধ করুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "বারবার মাথা ব্যথা হলে রক্তচাপ মাপা দরকার। চোখে ঝাপসা দেখা বা ফুলে যাওয়া থাকলে ঝুঁকি বেশি। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "বামে কাত হয়ে কিছুক্ষণ বিশ্রাম নিন এবং নড়াচড়া খেয়াল করুন। আগের চেয়ে কম থাকলে পরীক্ষা দরকার। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "নড়াচড়া শিশুর ভালো থাকার একটি সহজ সংকেত। প্রতিদিন একই সময়ে খেয়াল করলে পরিবর্তন বোঝা যায়। কম মনে হলে দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "প্রসবের পর মন খারাপ হতে পারে, কিন্তু দীর্ঘদিন থাকলে সাহায্য দরকার। শিশুর যত্ন নিতে কষ্ট হলে একা থাকবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "এমন চিন্তা এলে একা থাকবেন না এবং পরিবারের কাউকে বলুন। এটি সাহায্য নেওয়ার সময়। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "খুব বেশি দুর্বল লাগলে খাবার, পানি, রক্তশূন্যতা, বা অন্য সমস্যার কারণে হতে পারে। বিশ্রাম নিন এবং পরীক্ষা দরকার হতে পারে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শরীর খুব ফুলে গেলে রক্তচাপ মাপা দরকার। মুখ, হাত, চোখ ফুললে বিশেষ সতর্ক হন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "অল্প অল্প করে বারবার খাবার চেষ্টা করুন। ওজন কমে গেলে বা দুর্বলতা বাড়লে শরীরের শক্তি কমতে পারে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "দিনে অনেকবার বমি হলে শরীরের পানি কমে যেতে পারে। অল্প অল্প পানি পান করুন, কিন্তু পানি না থাকলে পরীক্ষা দরকার। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "প্রস্রাব কমে যাওয়া শরীরে পানি কমার লক্ষণ হতে পারে। মুখ শুকিয়ে গেলে বা মাথা ঘুরলে দেরি করবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "বমির সঙ্গে জ্বর থাকলে সংক্রমণ বা শরীরের পানি কমার ঝুঁকি থাকতে পারে। বিশ্রাম নিন এবং পানি পান করুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "ওজন না বাড়লে খাবারের পরিমাণ ও মান দেখতে হবে। ডাল, ডিম, মাছ, শাক, ফল, ও ভাত বা রুটি নিয়মিত খান। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "মায়ের খাবার কম হলে মা দুর্বল হতে পারেন এবং শিশুর বাড়তেও সমস্যা হতে পারে। ঘরের পুষ্টিকর খাবার বাড়ান। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  ...
  },
  {
    ...
    answer_bn: "শান্ত জায়গায় বামে কাত হয়ে শুয়ে খেয়াল করুন। পরিবার বা স্বাস্থ্যকর্মীকে সঙ্গে নিয়ে বোঝার চেষ্টা করুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "পরিষ্কার পানি অল্প অল্প করে পান করুন। পাতলা পায়খানা বেশি হলে শরীরের পানি কমে যেতে পারে। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "জায়গা পরিষ্কার ও শুকনা রাখুন। নখ দিয়ে বেশি আঁচড়াবেন না। স্রাব, দাগ, বা জ্বর থাকলে দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "জ্বর বারবার এলে কারণ জানা দরকার। পানি পান করুন, বিশ্রাম নিন, এবং নিজে ওষুধ খাবেন না। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  ...
  },
  {
    ...
    answer_bn: "অনেক সময় মা অসুস্থ থাকলেও বুকের দুধ চলতে পারে। তবে জ্বর, খুব দুর্বলতা, বা ওষুধের দরকার হলে দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শিশুর চোখ পরিষ্কার রাখুন এবং ময়লা হাত দেবেন না। পুঁজ, ফোলা, বা জ্বর থাকলে দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শিশুর শরীর বা চোখ খুব হলুদ দেখালে পরীক্ষা দরকার হতে পারে। শিশুকে দুধ খাওয়াতে থাকুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
  {
    ...
    answer_bn: "শিশু খুব নিস্তেজ থাকলে বা দুধ না খেলে দ্রুত দেখা দরকার। শিশুকে উষ্ণ রাখুন। দ্রুত স্বাস্থ্যকর্মীকে বা ডাক্তারকে জানান।",
    severity: "MODERATE",
    see_doctor: true,
    emergency: false
  },
